...
pixi run -e analysis $BASE_DIR/src/optimize_hydrogens_xtb.py lig_h.sdf # --verbose
pixi run -e analysis antechamber -i lig_h_opt.mol2 -fi mol2 -o lig.mol2 -fo mol2 -c bcc -s 2 -nc $CHARGE -rn LIG -an n -ek "maxcyc=0"
